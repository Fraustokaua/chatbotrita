...
function showTyping() {
    ...
    typing.setAttribute("aria-label", "Bot Paneas está digitando");
...
addMessage("Olá! Eu sou o Bot Paneas. Posso ajudar com saldo, Pix, cartão, extrato, pagamentos e segurança.", "bot");
addQuickActions();
